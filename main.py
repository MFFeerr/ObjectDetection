...
def box_l(image,box,n,ep,color=(128,128,128)):
        ...
        with open('ImagesPointsT.txt', 'a') as f:
        ...
        cv2.imwrite("CropT" + str(ep) + "/CropIm" + str(n) +"_"+ str(box[0])+ '.jpg', crop_i)
        cv2.waitKey(0)
...
for e in ep:
    ...
    model.train(data="C:/Users/HP/PycharmProjects/ProyectoFinal/Dataset/data.yaml", epochs=int(e))
    metrics = model.val()  # evaluate model performance on the validation set
    directory = 'C:/Users/HP/PycharmProjects/ProyectoFinal/Dataset/test/images'
    dic2 = 'C:/Users/HP/PycharmProjects/ProyectoFinal/Dataset/test/labels'
    num = 0
    noFound = 0
    IOULi = []
    DICELi = []
    for filename in os.listdir(directory):
        ...
        for box in res.boxes.boxes:
            if float(box[-2]) >= 0:
                ...
                x1,y1,x2,y2 = box_l(im, box,num,e)
